<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="养老院名称" prop="yanglaoyuanmingcheng">
					<el-input v-model="ruleForm.yanglaoyuanmingcheng" placeholder="养老院名称" clearable  :readonly="ro.yanglaoyuanmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="养老院名称" prop="yanglaoyuanmingcheng">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="老人性别" prop="laorenxingbie">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="心跳" prop="xintiao">
					<el-input v-model="ruleForm.xintiao" placeholder="心跳" clearable  :readonly="ro.xintiao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="心跳" prop="xintiao">
					<el-input v-model="ruleForm.xintiao" placeholder="心跳" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="听力" prop="tingli">
					<el-select :disabled="ro.tingli" v-model="ruleForm.tingli" placeholder="请选择听力" >
						<el-option
							v-for="(item,index) in tingliOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="听力" prop="tingli">
					<el-input v-model="ruleForm.tingli"
						placeholder="听力" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="健康情况" prop="jiankangqingkuang">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jiankangqingkuang" label="健康情况" prop="jiankangqingkuang">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jiankangqingkuang"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jiankangqingkuang = this.ruleForm.jiankangqingkuang.replace(reg,'../../../springboot1w568/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
