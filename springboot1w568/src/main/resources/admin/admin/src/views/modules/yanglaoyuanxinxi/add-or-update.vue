	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="养老院介绍" prop="yanglaoyuanjieshao">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.yanglaoyuanjieshao" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.yanglaoyuanjieshao" label="养老院介绍" prop="yanglaoyuanjieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.yanglaoyuanjieshao"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='yanglaoyuanjieshao'){
							this.ruleForm.yanglaoyuanjieshao = obj[o];
							this.ro.yanglaoyuanjieshao = true;
							continue;
						}
						if(o=='clicktime'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.yanglaoyuanjieshao = this.ruleForm.yanglaoyuanjieshao.replace(reg,'../../../springboot1w568/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yanglaoyuanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yanglaoyuanxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
